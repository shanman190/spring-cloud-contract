...
.groovy
----
include::{introduction_url}/samples/standalone/dsl/http-server/src/contractTest/resources/contracts/fraud/shouldMarkClientAsFraud.groovy[]
----

[source,yaml,indent=0,role="secondary"]
.yaml
----
include::{introduction_url}/samples/standalone/dsl/http-server/src/contractTest/resources/contracts/yml/fraud/shouldMarkClientAsFraud.yml[]
----
====
...
`contractsDslDir` property. By default, it is `$rootDir/src/contractTest/resources/contracts`.
...
IMPORTANT: Place the contract in the `src/contractTest/resources/contracts/fraud` folder. The `fraud` folder
...
`src/contractTest/resources/contracts/fraud`. Since you do not have two packages starting from
...
[source,java,indent=0]
----
include::{introduction_url}/samples/standalone/dsl/http-server/src/contractTest/java/com/example/fraud/FraudBase.java[]
----
====
