...
`src/contractTestest/resources/contracts` directory. The directory containing stub definitions is
...
Groovyn DSL. The default directory is `/src/contractTest/resources/contracts`.
