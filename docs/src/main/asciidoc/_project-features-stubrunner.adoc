...
`src/contractTest/resources/contracts/bar-consumer/some/contracts/...` folder) are allowed to be referenced.
...
`src/contractTest/resources/contracts/foo-consumer/some/contracts/...` folder) are allowed to be referenced.
